...
sap.ui.define(
  ...
  function (opaTest, Device) {
    ...
    opaTest(
      'Should see the Planning Calendar initially set',
      function (Given, When, Then) {
        ...
        // Assertions
        Then.onTheMainPage
          .thePlanningCalendarShouldHaveAllTeamMembers(oPCIds)
    ...
    opaTest(
      'Open a Legend when Planning Calendar is displayed',
      function (Given, When, Then) {
        // Actions
    ...
    opaTest(
      'Select a view from the Planning Calendar View Selector',
      function (Given, When, Then) {
        // Actions
    ...
    opaTest(
      'Click on the Planning Calendar Create Button',
      function (Given, When, Then) {
        // Actions
    ...
    opaTest(
      'Switch to the Single Planning Calendar',
      function (Given, When, Then) {
        // Actions
        ...
        // Assertions
        Then.onTheMainPage
          .theSinglePlanningCalendarIsLoaded(oSPCIds, 1)
    ...
    opaTest(
      'Open a Legend when Single Planning Calendar is displayed',
      function (Given, When, Then) {
        // Actions
    ...
    opaTest(
      'Select a view from the Single Planning Calendar View Selector',
      function (Given, When, Then) {
        // Actions
    ...
    opaTest(
      'Click on the Single Planning Calendar Create Button',
      function (Given, When, Then) {
        // Actions
    ...
    opaTest(
      'Switch back to the Planning Calendar',
      function (Given, When, Then) {
        // Actions
