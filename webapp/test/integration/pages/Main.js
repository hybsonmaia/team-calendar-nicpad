          ...
          iSelectACalendarView: function (oControlIds, sViewKey) {
            return this.waitFor({
              ...
              success: function (oCalendar) {
                var oViewSwitch = oCalendar
                  ._getHeader()
                  ._getOrCreateViewSwitch()
                this.waitFor({
          ...
          iSelectATeamMember: function (oControlIds, iSelectedMember) {
            return this.waitFor({
              ...
              success: function (oSelect) {
                var sSelectedMemberName = oSelect
                  .getItems()
                  [iSelectedMember].getText()
                this.waitFor({
                  ...
                  actions: new Press(),
                  errorMessage:
                    'Could not select an item of Team Member Selector'
                })
              },
        ...
        assertions: Object.assign({
            ...
            return this.waitFor({
              ...
              success: function (oSelector) {
                ...
                Opa5.assert.strictEqual(
                  ...
                  'The Calendar has ' +
                    iSelectorItems +
                    ' items and the Team Member Selector has (1 + ' +
                    iTeamCount +
                    ') items'
                )
              },
              errorMessage:
                'The Calendar does not have all Team Members in the Team Member Selector'
            })
          },
            ...
            return this.waitFor({
              ...
              success: function (oCalendar) {
                ...
                if (oCalendar.getViewKey) {
                  ...
                  sSelectedViewKey = oCore
                    .byId(oCalendar.getSelectedView())
                    .getKey()
                }
                Opa5.assert.strictEqual(
                  sExpectedViewKey,
          ...
          theMessageToastAppears: function () {
            return this.waitFor({
              ...
              success: function () {
                Opa5.assert.ok(true, 'The MessageToast appears')
              },
              errorMessage: "The MessageToast doesn't appear"
            })
          },

          theSinglePlanningCalendarIsLoaded: function (
            oControlIds,
            iSelectedMember
          ) {
            return this.waitFor({
              ...
              errorMessage:
                'The Planning Calendar is not switched to Single Planning Calendar'
            })
          }
        })
      }
